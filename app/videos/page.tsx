...
import { Play, Youtube, Award, Users, TrendingUp, Eye, ArrowLeft } from 'lucide-react'
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                >
                    <Link href="/#videos">
                        <motion.div
                            whileHover={{ x: -5 }}
                            className={`inline-flex items-center gap-2 text-emerald-600 hover:text-emerald-700 font-semibold ${language === 'bn' ? 'font-bengali' : ''}`}
                        >
                            <ArrowLeft className="w-5 h-5" />
                            {language === 'bn' ? 'হোমপেইজে ফিরে যান' : 'Back to Home'}
                        </motion.div>
                    </Link>
                </motion.div>
                ...
                <AnimatedSection className="text-center mb-20">
                    ...
                    <h1 className={`text-4xl md:text-5xl lg:text-6xl font-bold text-dark-900 mb-6 ${language === 'bn' ? 'font-bengali' : ''}`}>
                ...
                >
                    <p className={`text-dark-500 text-lg ${language === 'bn' ? 'font-bengali' : ''}`}>
                        {language === 'bn' ? 'আরও ভিডিও শীঘ্রই আসছে...' : 'More videos coming soon...'}
                    </p>
                </motion.div>
            </div>
        </main>
