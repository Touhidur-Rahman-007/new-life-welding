...
export default function VisaProcessing() {
  return (
    <section id="visa" className="relative py-20 md:py-32 bg-gradient-to-b from-emerald-50 via-teal-50 to-cyan-50 overflow-hidden">
      {/* Background Pattern */}
      ...
      <motion.div
        ...
        className="absolute bottom-40 left-20 w-32 h-32 bg-gradient-to-br from-cyan-400/20 to-emerald-400/20 rounded-full blur-xl"
      />
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
            Visa Processing <span className="bg-gradient-to-r from-emerald-500 to-teal-500 bg-clip-text text-transparent">Services</span>
          </h2>
