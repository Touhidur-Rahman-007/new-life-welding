...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      {/* Main button */}
      <motion.div
        className="relative flex items-center gap-3 px-5 py-4 rounded-full bg-gradient-to-r from-green-500 to-green-600 text-white shadow-2xl cursor-pointer overflow-hidden"
        animate={{
          y: [0, -8, 0],
        }}
        transition={{
      ...
      >
        ...
        <div className="relative flex flex-col">
          ...
          <span className="text-[10px] opacity-90">Chat with us!</span>
        </div>
